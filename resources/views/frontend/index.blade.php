...
<main>
             ...
             <div class="col">
               <div class="card shadow-lg p-3 mb-5 banglaFont myTableBg" style="border-radius: 10px;">
                 ...
                 <div class="card-footer text-center" style="background-color: rgb(161, 239, 245); border-radius: 10px;">
                     <h5 class="text-center runningTextAnimation"> বিঃদ্রঃ- প্রমানাদী পেলে এতিম, অসহায় ও গরীব ছাত্র/ছাত্রীদের বিশেষ ব্যবস্থা দেওয়া হবে এবং মা-বাবা না থাকলে একেবারে ফ্রি 
                     </h5>
                 </div>
                 ...
                 <div class="col">
                     ...
                     <div class="card-body">
                         ...
                         <tbody>
                             ...
                             <tr>
                                 <td>দ্বিতীয় জামাত মাসিক বেতন</td>
                                 <td>= ১২৫০/-</td> 
                             </tr>
                             <tr>
                                 <td>তৃতীয় জামাত মাসিক বেতন</td>
                                 <td>= ১৫০০/-</td> 
                             </tr>
                             <tr>
 ...
 <section>
     <div class="container">
         <div class="card mb-5" style="outline: 4px solid #f0740f; outline-offset: 1px;box-shadow: 1px 0px 10px 1px #26b456;border-radius: 20px;">
             ...
             <div class="card-body">
                 <h6>
                     ছাত্রদের সাথে প্রতিদিন আসর থেকে মাগরিব পর্যন্ত এবং শুক্রবার সকাল ৯ টা থেকে দুপুর ১২ টা পর্যন্ত সাক্ষাৎ করতে পারবেন, বিশেষ কারণে কর্তৃপক্ষের অনুমতি সাপেক্ষে অন্য সময় শিথিল যোজ্ঞ অনূর্ধ্ব ৫ মিনিট, তার উপরে নয়। ছাত্রদের সাথে প্রতিদিন আসর থেকে মাগরিব পর্যন্ত মোবাইলে কথা বলতে পারবেন, মোবাইলে কথা বলার সময় অনূর্ধ্ব তিন মিনিট এই নাম্বারেঃ- ০১৮৭৫৯০৫৫৫২ <br> কোন ছাত্র মাদ্‌রাসা য় মোবাইল সেট মেমোরি ইত্যাদি ব্যবহার করতে পারবেনা।
                 </h6>
             </div>
         </div>
     </div>
       ...
       <div class="card text-center p-1 mb-5 banglaFont foodAnimation" 
             ...
             <table class="table table-bordered border-primary p-2">
               ...
               <tbody class="text-dark">
                 ...
                 <tr>
                   ...
                   <td style="color: red;"> ভুনা খিচুড়ি </td>
                   <td>ভাত, মাছ, ডাল</td>
                   <td>ভাত, মাছ, ডাল</td>
                 </tr>
                 <tr>
         ...
         <div class="card-footer" style="background-color: rgb(168, 235, 252); border-radius: 10px;">
           <h5 class="text-center">
            বিঃ দ্রঃ- ছাত্রদের সুবিধার্থে মাঝে মাঝে খাবারের পরিবর্তন করা হয়ে থাকে
           </h5>
         </div>
       </div>
     </div>
             ...
             <div class="row">
                     ...
                     <div class="card">
                         ...
                         <div class="card-body">
                             <p>
                                 ...
                                 2. <strong>পরিবেশ নিশ্চিত করা:</strong> সন্তানের পড়াশোনার জন্য বাড়িতে শান্তিপূর্ণ ও মনোযোগপূর্ণ একটি পরিবেশ তৈরি করুন, যেখানে তারা নিরবচ্ছিন্নভাবে পড়াশোনা করতে পারবে। <br>
                                 3. <strong>শৃঙ্খলার উপর জোর দিন:</strong> তাদের সময়নিষ্ঠা, অধ্যবসায়, এবং নৈতিক মূল্যবোধ রপ্ত করার জন্য উৎসাহিত করুন। নিয়মিত সময়ে ঘুম, খাওয়া, এবং পড়াশোনার অভ্যাস গড়ে তুলতে সাহায্য করুন। <br>
                 ...
                 <div class="col-lg-6">
                    <div class="card" style="border-top-left-radius: 10px; box-shadow: -1px -1px 10px 11px #666464;">
                     <div class="card-body">
                         <p>
                             1. <strong>মাদ্‌রাসা র নিয়ম সম্পর্কে সচেতনতা:</strong>  মাদ্‌রাসা র নিয়ম-কানুন এবং নির্দেশিকা সম্পর্কে পূর্ণ ধারণা নিন। ভর্তি ও নিয়মিত ক্লাস, পরীক্ষার সময়সূচি, শিক্ষামূলক কার্যক্রম, পোশাকবিধি, এবং শৃঙ্খলা রক্ষা সংক্রান্ত নিয়মগুলো সম্পর্কে অবগত থাকুন এবং সন্তানেরা যেন সেগুলো মেনে চলে তা নিশ্চিত করুন। <br>
                             2. <strong>নিয়মিত উপস্থিতি নিশ্চিত করা: </strong>  মাদ্‌রাসা য় সন্তানের নিয়মিত উপস্থিতি নিশ্চিত করুন। অনুপস্থিতির ক্ষেত্রে যথাযথ কারণ জানিয়ে মাদ্‌রাসা  কর্তৃপক্ষকে অবহিত করুন। <br>
                             3. <strong>সঠিক পোশাক পরিধান: </strong>  সন্তানেরা যেন মাদ্‌রাসা র নির্ধারিত পোশাক এবং পরিচ্ছন্ন অবস্থায় উপস্থিত হয় তা নিশ্চিত করুন। ইসলামিক এবং ঐতিহ্যবাহী পোশাকবিধি মেনে চলার গুরুত্ব বোঝান। <br>
                             4. <strong> সময়নিষ্ঠা বজায় রাখা: </strong> সন্তানেরা যেন যথাসময়ে মাদ্‌রাসা য় পৌঁছায় এবং ক্লাসে মনোযোগ দেয় তা নিশ্চিত করার জন্য সময়নিষ্ঠ হওয়ার অভ্যাস গড়ে তুলুন। <br>
                             5. <strong>শৃঙ্খলার চর্চা:</strong>  সন্তানেরা যেন মাদ্‌রাসা র শৃঙ্খলা ও নিয়মানুবর্তিতা মেনে চলে তা নিশ্চিত করুন। শিক্ষক ও সহপাঠীদের সাথে ভদ্র ও সম্মানজনক আচরণ করার অভ্যাস গড়ে তুলতে সাহায্য করুন। <br>
                             6. <strong>অধিকতর পারফরম্যান্সের জন্য সহযোগিতা: </strong>  সন্তানেরা যদি কোনও বিষয়ে পিছিয়ে পড়ে তবে মাদ্‌রাসা র শিক্ষকদের সাথে পরামর্শ করে তাদের শিক্ষায় আরও উন্নতি করার ব্যবস্থা করুন। প্রয়োজনে টিউটরিং বা বাড়িতে অতিরিক্ত পড়াশোনার সুযোগ দিন। <br>
                             7. <strong>বিশেষ অনুষ্ঠানে অংশগ্রহণ: </strong>  মাদ্‌রাসা য় অনুষ্ঠিত বিশেষ অনুষ্ঠান, সেমিনার বা কর্মশালায় অভিভাবকদের অংশগ্রহণ গুরুত্বপূর্ণ। এতে করে সন্তানের শিক্ষার প্রতি আপনার আগ্রহ প্রকাশ পায়, যা তাদের আরও দায়িত্বশীল করে তোলে। <br>
                             8. <strong>আচরণগত পরিবর্তনের প্রতি নজর: </strong>  সন্তানের আচরণে পরিবর্তন লক্ষ্য করলে মাদ্‌রাসা  কর্তৃপক্ষকে তা অবহিত করুন এবং প্রয়োজনে তাদের পরামর্শ নিন। আচরণগত সমস্যার ক্ষেত্রে শিক্ষকদের সাথে মিলেমিশে সমাধান খোঁজার চেষ্টা করুন। <br>
                             9. <strong>অভিযোগ এবং পরামর্শ প্রদান:</strong> সন্তানের কোনো সমস্যা বা প্রয়োজনীয় উন্নতি সম্পর্কে মাদ্‌রাসা কে জানাতে দ্বিধা করবেন না। তবে তা শৃঙ্খলাভঙ্গের উপায়ে নয়, বরং সঠিক পদ্ধতিতে জানানোর চেষ্টা করুন। <br>
                             10. <strong> ইসলামিক মূল্যবোধ রক্ষায় অবদান রাখা: </strong> সন্তানদের ইসলামিক মূল্যবোধ ও শৃঙ্খলা রক্ষা করতে উদ্বুদ্ধ করুন এবং পরিবারের সদস্যরাও যেন মাদ্‌রাসা র নীতিমালা সম্মান করেন সেই বিষয়ে সচেতন থাকুন।
                           </p>
                     </div>
                    </div>
                 </div>
 ...
 {{-- Massage to guirdeans --}}
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="mb-4">মাদ্‌রাসা হেদায়াতুল উম্মাহ্‌ ঢাকা।</h1>
    ...
    <div class="container-xxl py-5">
        <div class="container">
                <h2 class=" bg-white text-center text-primary px-1 mb-5"> পড় তোমার প্রভুর নামে যিনি সৃষ্টি করেছেন </h2>
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item bg-light">
                        ...
                        <div class="text-center p-4">
                            <h5 class="mb-0"> তোমরা নামায প্রতিষ্ঠা কর এবং যাকাত দাও। তোমরা নিজের জন্য পূর্বে যে সৎকর্ম প্রেরণ করবে, তা আল্লাহর কাছে পাবে। তোমরা যা কিছু কর, নিশ্চয় আল্লাহ তা প্রত্যক্ষ করেন </h5>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item bg-light">
                        ...
                        <div class="text-center p-4">
                            <h5 class="mb-0">"যে ব্যক্তি খিয়ানত করবে, সে কিয়ামতের দিন তার খিয়ানতকৃত জিনিস মাথায় বহন করে উপস্থিত হবে। হয় তা হবে একটি উট, যা চিৎকার করবে, কিংবা একটি গরু, যা ডাকবে, অথবা একটি ছাগল, যার শব্দ থাকবে।"</h5>
                            <h6>[সহীহ বুখারী, হাদীস নম্বর: ২৪৪৯]</h6>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item bg-light">
                        ...
                        <div class="text-center p-4">
                            <h5 class="mb-0"> আবূ হুরাইরাহ্ (রাঃ) থেকে বর্ণিতঃ তিনি বলেন, রসূলুল্লাহ (সাল্লাল্লাহু ‘আলাইহি ওয়া সাল্লাম) বলেছেনঃ যে ব্যক্তি কারো দুনিয়ার কোনো বিপদ দুর করবে, মহান আল্লাহ তাকে কিয়ামতের দিনের বিপদ থেকে রক্ষা করবেন।</h5>
